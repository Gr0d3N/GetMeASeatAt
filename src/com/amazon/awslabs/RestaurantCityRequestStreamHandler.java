...
public final class RestaurantCityRequestStreamHandler extends SpeechletRequestStreamHandler {
    ...
    private static final Logger log = LoggerFactory.getLogger(RestaurantCityRequestStreamHandler.class);
    ...
    static {
        ...
        try {
            ...
            log.warn("Failed to get {} environment variable with exception: {}", APPLICATION_ID,
